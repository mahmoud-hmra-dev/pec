                        ...
                        <div class="col-md-12">
                            <form action="{{route('login')}}" method="post">
                                ...
                                <div class="row  align-items-center justify-content-end">
                                    ...
                                    <div class="form-group col-md-12 title text-center">
                                        <h3>Patient Empowerment and Centricity</h3>
                                        <h2>Unlocking Patient Empowerment</h2>
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-4 d-flex align-content-center justify-content-between">
                                        <div class="">
                                        ...
                                        <div class="">
                                            @if (Route::has('password.request'))
                                                <a class="forget-password" href="{{route('password.request')}}">I forgot my password</a>
                                            @endif
                                        </div>
                                    </div>
