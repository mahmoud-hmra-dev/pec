                ...
                <form id="frm_add" class="add-form" method="POST">
                    ...
                    <div class="row is_eligible">
                        <div class="row is_eligible col-md-12" >
                            ...
                            <div class="form-group col-md-6 " id="consent_document">
                                ...
                                <label id="consent_document_file"></label>
                            </div>
                            <div class="form-group col-md-12 edit_sub_program_patient">
                                <label class="required-label" for=""> </label>
                                <div class="custom-control custom-switch">
                                    ...
                                    <label for="is_their_safety_report" class="custom-control-label">Is their safety report</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row is_eligible">
                        <div class="form-group col-md-6 " id="nurse_visits">
                            <label class="required-label" for="edit_nurse">Nurse</label>
                            <select class="form-control select2" id="edit_nurse" name="nurse">
                                {{--
                        ...
                        <div class="form-group col-md-6 " id="coordinator_calls">
                            <label class="required-label" for="edit_coordinator">Coordinator</label>
                            <select class="form-control select2" id="edit_coordinator" name="coordinator">
...
@push('scripts')
    <script>
        ...
        $(".calculate_BMI").on('keyup',function (event) {
            ...
            if( weight != "" && height != "" && height != 0){
                ...
                $("#BMI").val(BMI);
                if(BMI > 27){
                    $("#is_over_weight").attr("checked",true);
                } else {
                    $("#is_over_weight").attr("checked",false);
                }
            }
        });
