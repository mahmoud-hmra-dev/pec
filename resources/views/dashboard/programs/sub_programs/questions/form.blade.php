                ...
                <form id="frm_add" class="add-form" method="POST">
                    ...
                    <div class="row" id="no-choices">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control question_types select2" id="question_type_id" name="question_type_id" >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control categories select2" id="category_id" name="category_id" >
                    ...
                    <div class="row">
                        <div class="repeater container" id="choices">
