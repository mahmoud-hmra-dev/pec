    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="ModelLabel">Add New Country</h4>
            ...
            <div class="modal-body">
                <form id="frm_add" class="add-form" method="POST">
                    ...
                    <div class="form-group">
                        <label class="required-label">Phone Extension</label>
                        <input type="text" name="phone_extension" class="form-control">
                    </div>

                    <div class="form-group">
                        <label class="d-block">Is Active</label>
                        <input type="checkbox" id="is_active" switch="primary" name="is_active"/>
