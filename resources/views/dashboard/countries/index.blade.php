...
<div class="p-4">
    ...
    <div style="min-height: 300px;">
        <table class="table table-bordered table-striped" id="countries-table">
            <thead>
            <tr>
                <th>Id</th>
                <th>Name</th>
...
@component('dashboard.countries.form')
@endcomponent
...
<script>
    $(function () {
        ...
        table.on('click', '.delete', function () {
            ...
            deleteOpr(data.id, `dashboard/countries/` + data.id, table);
        });
    ...
    openEdit = (data) => {
        ...
        $form.attr('action', `dashboard/countries/` + data.id);
