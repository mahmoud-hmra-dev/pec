...
@component('dashboard.enroll_patient.form',['hospitals'=>$hospitals,'drugs'=>$drugs,'programs'=>$programs,'sub_programs_countries'=>$sub_programs_countries])
@endcomponent
@component('dashboard.enroll_patient.view')
@endcomponent
@stop
@push('scripts')
<script>
    $(function () {
        ...
        table.on('click', '.delete', function () {
            ...
            deleteOpr(data.id, `dashboard/enroll_patient/` + data.id, table);
        });
    ...
    openAdd = () => {
        ...
        clearForm($form);
        $form[0].reset();
        $form.attr('action', `dashboard/enroll_patient`);
