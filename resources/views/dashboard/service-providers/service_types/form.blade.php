            ...
            <div class="modal-body">
                <form id="frm_add" class="add-form" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="required-label">Code</label>
                            <input type="text" value="{{old('code')}}" name="code" class="form-control">
                        </div>

                        <div class="form-group col-md-6">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input is_one" id="is_one" switch="primary" name="is_one" @if(old("is_one")) checked @endif/>
                                <label for="is_one" class="custom-control-label">Is one</label>
                            </div>
                        </div>
                    </div>
