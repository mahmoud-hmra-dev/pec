...
class VisitCallCompletedController extends Controller{
    ...
    */
    public function index(Request $request )
    {
        ...
        return view('dashboard.visits_calls.completed.index',['activity_types'=>$activity_types,'sub_program_patients'=>$sub_program_patients,'sub_programs'=>$sub_programs,'nurses'=>$nurses,'questions'=>$questions,'programs'=>$programs]);
    }
}
